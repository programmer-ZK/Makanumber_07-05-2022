<div class=" mb-3 pb-2  w-100">
  ...
  <ul class="mb-5 ml-3" style="margin-left:-25px; font-family:sans-serif !important;">
    ...
    <li class="m-2" style="float:left !important; font-family:sans-serif !important;">
      <a href="https://twitter.com/intent/tweet?url={{ urlencode(url()->current()) }}&text={{ $description }}" target="_blank" title="{{ __('Share on Twitter') }}"><i class="fab fa-twitter btn btn-primary p-2" style="padding:5px; width:121px; background-color:#55ACEE; "> <span style="font-family:sans-serif !important;"> twitter</span></i></a>
    </li>
    <li class="m-2" style="float:left !important;">
