...
<body style="overflow-x: hidden;">
    ...
    <div class="main-content">
      <nav class="navbar navbar-expand-lg navbar-light bg-light"
          style="font-weight:bold ; margin-top:-40px;font-family: 'Montserrat', sans-serif !important;">
            ...
            <div class="dropdown-menu">
              ...
              <a class="dropdown-item" href="/privacy-policy">Privacy Policy</a>
                  ...
                  <li class="nav-item mt-2 ml-3 active" style="border:none !important;">
                      <span class="mr-5">
                          <img class="flag mr-1"
                              src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/Flag_of_Pakistan.svg/320px-Flag_of_Pakistan.svg.png" />
                          <img class="flag1"
              ...
              <form class="form-inline my-2 my-lg-0  mr-5">
                  @if (Auth::user())
                      ...
                      @endphp
                          <li class="nav-item ml-2 mr-0" style="list-style:none !important;">
                              <img src="{{ asset('public/storage/' . $avatar->url) }}"
                                  style="width:30px; height:30px; border-radius:50%; border:1px solid;" />
                          </li>
                      @else
                          <li class="nav-item ml-2" style="list-style:none !important;">
                              <img src="/frontend-images/profile-pic.jpg"
                                  style="height:30px; width:30px; border-radius:50%;" />
                          </li>
                      @endif
                      <div class="dropdown mr-5">
                          <li class="nav-item active" type="button" id="dropdownMenuButton" data-toggle="dropdown"
                              aria-haspopup="true" aria-expanded="false" style="border:none !important;">
                              <span class="nav-link " href="#">{{ Auth::user()->username }} <i
                          ...
                          @if (Auth::user()->super_user == 1 || Auth::user()->super_user == 0)
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                  ...
                                  @if ($user_role_id == 3)
                                      <a class="dropdown-item" href="/my-profile" class="btn-logout"><i
                                              class="fas fa-user"></i> My Profile </a>
                                  @else
                                      <a class="dropdown-item"
                                          href="/admin/system/users/profile/{{ Auth::user()->id }}"
                                          class="btn-logout"><i class="fas fa-user"></i> My Profile </a>
                                  @endif

                                  <a class="dropdown-item" href="{{ route('access.logout') }}"
                                      class="btn-logout"><i class="fas fa-sign-out-alt"></i> Logout</a>
                  ...
                  @else
                      <div class="dropdown-menu  mr-5" aria-labelledby="dropdownMenuButton">
                          ...
                          <a class="dropdown-item" href="/my-profile" class="btn-logout"><i
                                  class="fas fa-user"></i> My Profile</a>
                          <a class="dropdown-item" href="{{ route('access.logout') }}" class="btn-logout"><i
    ...
    <div class="container-fluid" style="background-color:#F6F6F6;">
        <div class="row  pt-5 pb-5">
            ...
            <div class="footer_coloumn footer_coloumn_1 col-sm-3 ml-5 text-justify  ">
                <a href="/">
                    <img src="/frontend-images/logo.png" alt="footer-img" style="width:290px; height:50px;"
                        class="footer-img">
                </a>
            ...
            <div class="footer_coloumn footer_coloumn_3   col-sm-2  padding ">
                ...
                <ul class="ul">
                    <li class="li pb-3">
                        <a href="/search-propeties?purpose=selling&propertyType=1"
                            style=" color:black !important;">Apartments</a>
                    </li>

                    <li class="li pb-3">
                        <a href="/search-propeties?purpose=selling&propertyType=2"
                            style=" color:black !important;">Villas</a>
                    </li>
                    ...
                    <li class="li pb-3">
                        <a href="/search-propeties?purpose=selling&propertyType=4"
                            style=" color:black !important;">Lands</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="footer_coloumn footer_coloumn_4  col-sm-2  padding   ">
                ...
                <ul class="ul">
                    <li class="li pb-3">
                        <a href="/search-propeties?purpose=renting&propertyType=1"
                            style=" color:black !important;">Apartments</a>
                    </li>

                    <li class="li pb-3">
                        <a href="/search-propeties?purpose=renting&propertyType=2"
                            style=" color:black !important;">Villas</a>
                    </li>
                    ...
                    <li class="li pb-3">
                        <a href="/search-propeties?purpose=renting&propertyType=4"
                            style=" color:black !important;">Lands</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="row pl-5 pr-5 " style="background-color:#f9f9f9;">
            <div class="col-sm-8 pt-2 pb-2" style="border-top: 1px solid gray;">
                ...
                <a href="https://octopusdigitalnetwork.com/"
                    style="color: #00B4A2 !important; text-decoration: underline;">
                    Octopus Digital Network.
                </a>
            </div>

            <div class="col-sm-4 pt-2 pb-2 display"
                style="border-top:1px solid black; text-align:right !important; float:right;">
                <a style="text-decoration: underline; color:black;" href="/privacy-policy">Terms of use.</a> <a
                    style="text-decoration: underline; color:black;" href="/privacy-policy"> Privacy Ploicy</a>
            </div>
